...
/// Dynamic Splash & Physics Break-Apart Intro Animation.
///
...
class _Intro3DOverlayState extends State<Intro3DOverlay>
  ...
  Widget build(BuildContext context) {
    ...
    // 1. Left Arm (Dumbbell):
    // Moves left: -140px, falls down: +480px with gravity, rotates CCW: -30 degrees
    ...
    // Moves right: +140px, falls down: +480px with gravity, rotates CW: +30 degrees
